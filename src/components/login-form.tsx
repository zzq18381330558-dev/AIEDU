...
export function LoginForm() {
  ...
  return (
    <form action={formAction} className="rounded-lg border border-line bg-white p-7 shadow-soft">
      ...
      <p className="mt-2 text-sm text-muted">使用种子账号或数据库中的员工账号登录。</p>

      <label className="mt-7 block text-sm font-medium text-ink" htmlFor="email">
        邮箱
      </label>
      <input
        id="email"
        ...
        type="email"
        autoComplete="email"
        defaultValue="admin@aiedu.local"
